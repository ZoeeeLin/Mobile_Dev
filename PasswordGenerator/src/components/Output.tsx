...
type outputPropType = {
    generatedPassword : string, // The password generated which will be displayed to user
    placeholder : string,
    handleCopy : (textToCopy : string) => void, //Function reference which will called when user press on copy icon in the Output component. 
                                                //This function will receive the generatedPassword string as parameter
}
